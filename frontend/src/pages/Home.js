    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1 className="hero-title">
            {profile?.name || "Your Name"}<br />
            <span className="line2">Full Stack Dev.</span>
          </h1>
          <p className="hero-desc">
            {profile?.bio || "I build modern, scalable web applications with a passion for clean code and great user experiences."}
          </p>
          <div className="hero-actions">
            <Link to="/projects" className="btn btn-primary">View My Work</Link>
            <Link to="/contact" className="btn btn-outline">Get In Touch</Link>
        ...
        <div className="container">
          <div className="two-col">
            <div>
              ...
              <p style={{ color: "var(--text2)", lineHeight: 1.85, marginBottom: 32 }}>
                Based in <strong style={{ color: "var(--text)" }}>{profile?.location}</strong>, I specialize in building full-stack applications — from pixel-perfect frontends to robust backend APIs. I care deeply about performance, accessibility, and developer experience.
              </p>
              <div style={{ display: "flex", gap: 16 }}>
                {profile?.social?.github && (
                  <a href={profile.social.github} target="_blank" rel="noreferrer" className="btn btn-outline" style={{ padding: "10px 20px", fontSize: "0.85rem" }}>GitHub</a>
                )}
                {profile?.social?.linkedin && (
                  <a href={profile.social.linkedin} target="_blank" rel="noreferrer" className="btn btn-outline" style={{ padding: "10px 20px", fontSize: "0.85rem" }}>LinkedIn</a>
                )}
              </div>
            </div>
